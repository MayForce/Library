...
public class DatabaseFunctions {
    ...
    public static boolean register(Connection c, String username, String name, String address,String phoneNumber, String password, int isLibrarian){
        PreparedStatement preparedStatement;
        ResultSet resultSet;
        String query = "insert into users (username, name, address, phone_number, card_number, password, isLibrarian)" + " values (?, ?, ?, ?, ?, ?, ?)";
        ...
        try {
            ...
            preparedStatement.setInt(7, isLibrarian);
